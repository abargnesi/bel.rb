      ...
      class StatementConverter
        ...
        def convert(bel_statement)
          ...
          when bel_statement.simple?
            ...
            sg << subg
            sg << objg
            sg << s(stmt_uri, RDF.type,           BELV1_0.Statement)
            sg << s(stmt_uri, BELV1_0.hasSubject,      sub_uri)
            sg << s(stmt_uri, BELV1_0.hasObject,       obj_uri)
            sg << s(stmt_uri, BELV1_0.hasRelationship, rel_uri) if rel_uri
